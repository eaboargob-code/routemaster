...
import { collection, onSnapshot, doc, getDoc, writeBatch, increment, serverTimestamp, type DocumentData } from 'firebase/firestore';
...
export function Roster({ tripId, schoolId, canEdit }: RosterProps) {
